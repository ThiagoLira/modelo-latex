...
\begin{figure}[H]
  \centering
  \includegraphics[width=.6\textwidth]{forecast_deep_ar1.pdf} 
...
\begin{figure}[H]
  \centering
  \includegraphics[width=.6\textwidth]{forecast_deep_ar3.pdf} 
...
\begin{figure}[H]
  \centering
  \includegraphics[width=.6\textwidth]{forecast_deep_ar7.pdf} 
...
distribuição desconhecida, a qual podemos estimar seus momentos com esses
valores. Usamos a média dessas distribuições para calcular o erro quadrático
como reportado na Tabela~\ref{tb:rmsedeepar}. Porém, com o desvio-padrão também podemos
reportar o risco das predições para diversos percentis, como explicado na Sessão~\ref{sec:quant}.
