...
onde começam os dados de validação (i.e. os dados não usados para treinamento), a Figura \ref{fig:distr_lin} permite comparar as distribuições previstas pelos 3 modelos:
