...
diferença entre as predições de $reglin\_7$ e as medidas reais de RC28 do período
...
$\alpha$, cujo resultado é o vetor filtrado diff\_ew. O algoritmo da média móvel é 
definido na Equação~\ref{eq:ew}.
...
diff\_ew. Os intervalos usados (emparelhados) são $t \in [T-1,T-1+t_f]$ e $i \in
[T-29,T-29+t_f]$.
