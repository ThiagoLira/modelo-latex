...
entre dados e anotacoes para que possamos anotar novos dados inéditos para os
...
probabilidade $p$. Formalmente, para um vetor de ativações $a$ na saída de uma
...
Pode-se demonstrar que isso é equivalente a considerar os
