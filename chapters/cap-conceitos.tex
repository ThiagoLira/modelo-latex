...
Queremos realizar uma predição de uma série temporal. Ou seja, dado valores passados queremos prever o comportamento da série num horizonte de tempo futuro finito. 

Seja uma série temporal indexada por instantes de tempo $t$ (onde ocorrem medições por exemplo), para cada instante $t$ temos um par $(y,\textbf{x})$ 
...
\subsection{Modelo Auto-regressivo}
