...
verossimilhança} \citep{gpml}. Isso se deve ao fato que a distribuição de
...
Médio, pode ser escrito apenas como:
...
é uma funcao usada para guiar os algoritmos de otimização na direcão de parâmetros que melhorem a performance do modelo \citep{dlbook}. Isso é feito, como explicado na Sessão~\ref{sec:reglog}, aproximando a distribuição gerada pelo modelo da distribuição observada pelos dados. \\
