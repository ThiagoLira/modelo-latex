...
de \textit{codificacoes}) e usa-a para gerar saídas sequencialmente, podendo
...
está indicado o codificacoes entre o decoder e o encoder. Esse codificacoes é apenas
...
dados. Isso quer dizer que os codificacoess da rede encoder-decoder são frutos de
...
arquitetura consiste em uma rede \textbf{encoder-decoder} que aprende codificacoess da
série temporal (i.e. uma representacão que extraia informações úteis para o
problema) e então uma rede \textbf{forecaster} que usa esses codificacoess ao lado de
