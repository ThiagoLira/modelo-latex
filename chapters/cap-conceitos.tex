...
observado um valor de X, dado que essa variável é distribuída normalmente, com média $\mu$ e variância $\sigma^2$), e
...
i.i.d., nesse caso, a log-verossimilhança total é dada por:
...
O Erro Quadrático Médio é um estimador não enviesado desse valor \cite{dlbook},
distante apenas por constantes. Então, podemos calcular o erro total de um
conjunto de dados apenas por:
