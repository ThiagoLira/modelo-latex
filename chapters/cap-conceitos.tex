...
pela observação dos dados. No campo de Aprendizado Automático, as duas maneiras de se gerar predições são estimadores
...
Usando a nomenclatura Bayesiana, teste$p(y^* | x^*,\theta)$ é a verossimilhança de
