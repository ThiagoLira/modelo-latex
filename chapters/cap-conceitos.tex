...
Nota-se que para essa modelagem outros valores de RC28 (e suas variáveis) temporalmente próximos do
...
Usaremos valores passados dos covariados a da
...
agregadas para cada índice $t$ como um vetor $\textbf{x}_t$. O treinamento será
realizado com valores nos instantes de tempo no intervalo $[1,T]$. Seja $T$ o último dia em que se possui dados de todas essas
