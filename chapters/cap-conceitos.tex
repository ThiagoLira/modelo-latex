...
modelo equivale em aproximar numericamente  a Integral~\ref{eq:int}, usando uma distribuição $q(\theta)$ que
cumpriria o papel de aproximar a distribuição intratável $p(\theta | X,Y)$ na inferência Bayesiana. \\
