...
O Risco Empírico é calculado pela soma do \textbf{Custo} da predição do modelo para cada ponto datual.
...
A verossimilhança é a medida da probabilidade do modelo
com um determinado conjunto de parâmetros ter gerado os dados. Usando um exemplo de aprendizado supervisionado onde
...
são derivados do Método de Máxima Verossimilhança. Para regressão usa-se o \textbf{Erro
Quadrático Médio}.
...
consideremos um erro Gaussiano. Sejam valores reais de anotação $Y$ e as
