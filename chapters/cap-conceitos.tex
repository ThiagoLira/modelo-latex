...
de \textit{acoplamento}) e usa-a para gerar saídas sequencialmente, podendo
...
está indicado o acoplamento entre o decoder e o encoder. Esse acoplamento é apenas
...
dados. Isso quer dizer que os acoplamentos da rede encoder-decoder são frutos de
...
arquitetura consiste em uma rede \textbf{encoder-decoder} que aprende acoplamentos da
série temporal (i.e. uma representacão que extraia informações úteis para o
problema) e então uma rede \textbf{forecaster} que usa esses acoplamentos ao lado de
