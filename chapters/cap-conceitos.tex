...
intervalo $[T-29-t_d,t-29]$, $t_d$ um hiper-parâmetro. Usa-se esse dataset para calcular pesos de 3 regressões
diferentes para a predição de RC28.
...
dos lotes expedidos nos dias $T-1$,$T-4$ e $T-8$. Os modelos descritos na
...
reglin\_3 em $T-4$ e reglin\_7 em $T-8$. Os modelos treinados dessa maneira são
aplicados por $t_f$ dias, a medida que novos índices de resistência são
calculados. A Tabela~\ref{tab:ranges} mostra para cada modelo os intervalos de
datas usadas para treinamento e predição.
...
escolhido de acordo com a necessidade de controle de qualidade da fábrica. 
