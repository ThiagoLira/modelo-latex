...
é uma funcao usada para guiar os algoritmos de otimização na direcão de parâmetros que melhorem a performance do modelo \cite{dlbook}. Isso é feito, como explicado na Sessão~\ref{sec:exp}, aproximando a distribuição gerada pelo modelo da distribuição observada pelos dados. \\
