...
\begin{resumo}{port}
  ...
  compressiva do cimento. Nossos resultados criam o caminho para que
  profissionais da industria passem a integrar modelos similares na tomada de
...
achieve robust and accurate predictions of the compressive strength. Our work
paves the way so that similar models might be integrated on day-to-day
