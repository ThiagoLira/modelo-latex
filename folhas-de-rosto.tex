...
% sugeridas da USP
\begin{resumo}{port}
Esse trabalho reproduz modelos de Deep Learning usados em problemas de
...
estatísticos nessa área não usaram o estado-da-arte de modelos sequenciais para
modelagem de séries temporais. Os dados foram cedidos pela multinacional
...
neurais e árvores de decisão e modelos sequenciais como LSTMs e modelos
profundos Bayesianos. 
\end{resumo}
...
\begin{tabular}{rl}
        ML         & Aprendizado de Máquina (\emph{Machine Learning})\\
...
\begin{tabular}{rl}
        ...
        $\mathcal{N}(\mu,\,\sigma^{2})$      & Distribuição Normal com média $\mu$  e desvio-padrão $\sigma$\\
