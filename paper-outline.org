...
This work has applied Bayesian Deep Learning techniques to the prediction with uncertainty of cement strength. The results of the RMSE measures are similar to state of the art results using
